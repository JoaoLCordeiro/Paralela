...
extern void chrono_start( chronometer_t *chrono );

extern long long  chrono_gettotal( chronometer_t *chrono );

extern long long  chrono_getcount( chronometer_t *chrono );

extern void chrono_stop( chronometer_t *chrono );
